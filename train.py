...
"""
from models.for2d.ResNet18 import ResNet18
from models.for2d.ResNet18Hybrid import ResNet18Hybrid
from models.for2d.ResNet50Hybrid import ResNet50Hybrid
from models.for2d.ResNet50 import ResNet50
from models.for3d.I3D import I3D
from models.for3d.MC18_3D import MC18_3D
from models.for3d.ResNet18_3d import ResNet18_3D
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if auc_metric > best_metric:
                ...
                model_dir = exp_save_root / model_name
                ...
                torch.save(checkpoint, model_dir / f"best_{config.MODE}_metric_model.pth")

                # --- LIGHTWEIGHT .NPY METADATA (for compatibility) ---
                metadata = {
                    "train_csv": train_csv_path,
                    "valid_csv": valid_csv_path,
                    "config": config,
                ...
                np.save(model_dir / "config.npy", metadata)

                logging.info(f"✅ Saved new best checkpoint with AUC={best_metric:.4f} at epoch {best_metric_epoch}")
